"""
Training entry point for the FULL-FRAME two-hand model (lib/models/hawor_full.py).
...
from lib.datasets.hawor_full_dataset import HaworFullDataset as HaworChunkDataset
from lib.models.hawor_full import HaworFull as HAWOR


def train_collate(items):  # full-frame model reads the batch directly
